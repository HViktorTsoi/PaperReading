...
CmBN：modified CBN，将1个batch划分为4个mini batch，对每一个mini Batch，分别accumulate W，再accumulate 这个mini batch对应的BN(传统的BN是accumulate)，然后normalize BN，但是不更新W和BN的参数，直到最后一个